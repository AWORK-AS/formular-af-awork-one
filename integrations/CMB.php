...
class CMB extends Base {
	...
	public function cmb_demo_metaboxes() { // phpcs:ignore
		...
		$cmb_demo = \new_cmb2_box(
			array(
				'id'           => $prefix . 'metabox',
				'title'        => \__( 'Demo Metabox', CFA_TEXTDOMAIN ),
		...
		$field1 = $cmb_demo->add_field(
			array(
				'name' => \__( 'Text', CFA_TEXTDOMAIN ),
				'desc' => \__( 'field description (optional)', CFA_TEXTDOMAIN ),
				'id'   => $prefix . CFA_TEXTDOMAIN . '_text',
				'type' => 'text',
				)
			);
		$field2 = $cmb_demo->add_field(
			array(
				'name' => \__( 'Text 2', CFA_TEXTDOMAIN ),
				'desc' => \__( 'field description (optional)', CFA_TEXTDOMAIN ),
				'id'   => $prefix . CFA_TEXTDOMAIN . '_text2',
				'type' => 'text',
				)
			);
		...
		$field3 = $cmb_demo->add_field(
			array(
				'name' => \__( 'Text Small', CFA_TEXTDOMAIN ),
				'desc' => \__( 'field description (optional)', CFA_TEXTDOMAIN ),
				'id'   => $prefix . CFA_TEXTDOMAIN . '_textsmall',
				'type' => 'text_small',
				)
			);
		$field4 = $cmb_demo->add_field(
			array(
				'name' => \__( 'Text Small 2', CFA_TEXTDOMAIN ),
				'desc' => \__( 'field description (optional)', CFA_TEXTDOMAIN ),
				'id'   => $prefix . CFA_TEXTDOMAIN . '_textsmall2',
				'type' => 'text_small',
		)
			);
