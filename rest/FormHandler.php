...
class FormHandler {
    ...
    private function verify_hcaptcha( $token ) {
        ...
        if ( empty( $secret_key ) ) {
            ...
            return array( 'success' => false, 'error-codes' => array( 'missing-secret-key' ) );
        }
        ...
        $verify_data = array( 'method' => 'POST', 'body' => $data, 'timeout' => 15 );
        ...
        if ( \is_wp_error( $response ) ) {
            ...
            return array( 'success' => false, 'error-codes' => array( 'wp-remote-error' ) );
        }
        ...
        if ( !is_array( $result ) || !isset( $result['success'] ) ) {
            return array( 'success' => false, 'error-codes' => array( 'invalid-response' ) );
        }
