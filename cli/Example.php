...
namespace Contact_Form_App\Cli;
...
if ( \defined( 'WP_CLI' ) && WP_CLI ) {
	...
	class Example extends Base {
		...
		public function __construct() {
			\WP_CLI::add_command( 'cfa_commandname', array( $this, 'command_example' ) );
		}
		...
		public function initialize() {
			if ( !\apply_filters( 'contact_form_app_cfa_enqueue_admin_initialize', true ) ) {
				return;
			}
